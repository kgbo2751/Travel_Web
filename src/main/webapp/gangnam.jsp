...
<html>
	<head>
		...
		<script type="text/javascript" src="js/gangnam.js"></script>
	</head>
	<body>
		<nav>
            <ul class="main">
	    ...
	    <div id="place">
			<div id="sec1">
				<div class="images">
		            <ul class="pan">
		                <li><img src="images/gangnam.jpg" class="slide"></li>
		                <li><img src="images/gangnam2.jpg" class="slide"></li>
		                <li><img src="images/gangnam3.jpg" class="slide"></li>
		            </ul>
		        </div>
		        
		        <div id="map">
		        	<div id="daumRoughmapContainer1702954505440" class="root_daum_roughmap root_daum_roughmap_landing"></div>
					<script charset="UTF-8" class="daum_roughmap_loader_script" src="https://ssl.daumcdn.net/dmaps/map_js_init/roughmapLoader.js"></script>
					<script charset="UTF-8">
						new daum.roughmap.Lander({
							"timestamp" : "1702954505440",
							"key" : "2h9je",
							"mapWidth" : "550",
							"mapHeight" : "200"
						}).render();
			...
			<div id="sec2">
				<div id="content_wrap">
					<%
						...
						try{
							...
							String sql="select * from gangnam;";
				...
				<div id="comment">
					...
					<div id="comment_wrap">
						<div id="comment_main">
							<form method="post" action="gangnam_comment_submit.jsp">
						...
						<%
							...
							try{
								...
								String sql2="select * from comment3;";
