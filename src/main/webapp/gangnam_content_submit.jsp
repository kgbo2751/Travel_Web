...
<html>
	...
	<body>
		<%
			...
			String sql="insert into gangnam (img1, detail1, img2, detail2, img3, detail3, img4, detail4, img5, detail5, img6, detail6)";
			...
			try{
				...
				stmt.execute(sql);
				response.sendRedirect("gangnam_content_developer.jsp");
			}catch(Exception e){
