...
<html>
	<head>
		...
		<title>Jongro</title>
		<link rel="stylesheet" href="css/jongro.css">
		<script src="jquery-3.7.1.min.js"></script>
		<script type="text/javascript" src="js/jongro.js"></script>
	</head>
	<body>
		<nav>
            <ul class="main">
                <li><img src="images/menu.png" id="icon">
                    <ul class="sub">
                    	...
                    	<form method="post" action="myeongdong.do">
                    		<div class="list">
                    			<input type="submit" value="명동" class="list_text">
                    		</div>
                    	</form>
	    ...
	    <div id="place">
			<div id="sec1">
				<div class="images">
		            <ul class="pan">
		                <li><img src="images/jongro.jpg" class="slide"></li>
		                <li><img src="images/jongro2.jpg" class="slide"></li>
		                <li><img src="images/jongro3.jpg" class="slide"></li>
		            </ul>
		        </div>
		        
		        <div id="map">
		        	<div id="daumRoughmapContainer1702954702422" class="root_daum_roughmap root_daum_roughmap_landing"></div>
					<script charset="UTF-8" class="daum_roughmap_loader_script" src="https://ssl.daumcdn.net/dmaps/map_js_init/roughmapLoader.js"></script>
					<script charset="UTF-8">
						new daum.roughmap.Lander({
							"timestamp" : "1702954702422",
							"key" : "2h9jj",
							"mapWidth" : "550",
							"mapHeight" : "200"
						}).render();
			...
			<div id="sec2">
				...
				<div id="comment">
					...
					<div id="comment_wrap">
						<div id="comment_main">
							<form method="post" action="jongro_comment_submit.jsp">
